...
function GamePage({ games, user, setUser }) {
  ...
  if (game) {
    const { title, description, genre, release_date, publisher, price, carousel_image, game_trailer, platforms } = game;
    ...
    return (
      <div className='game-page-container'>
        ...
        <section className='game-information'>
          <p key={crypto.randomUUID()} className='game-description'>{description}</p>
            ...
            <article className='platform-release-date'>
              ...
              <div className='platforms'>
                {platforms.map((platform) => {
                  return <p key={crypto.randomUUID()} className='platform'>{platform.platform}</p>;
                })}
              </div>
            </article>
          </section>
        ...
        {purchased ? (
          ...
          <div className='sticky-bottom'>
            <Button onClick={handlePurchase} className='purchase-button' variant="danger">
              Purchase: {price}
            </Button>
          </div>
        )}
